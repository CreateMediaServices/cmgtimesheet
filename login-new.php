<?php
    ...
    $sql = "SELECT * FROM cmg_user where userName='".$uNameValue."' AND userPassword='".$uPasswordValue."'";
    $result = $db->query($sql);
    if ($result->num_rows > 0) {
        ...
        try {
            ...
            $stmt = $conn->prepare("UPDATE cmg_user SET uLastLogin=:uLastLogin WHERE userName='".$uNameValue."'");

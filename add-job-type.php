                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="c-form-item">
                                                    ...
                                                    <select style="width: 100%" name="clients" id="clients">
                                            ...
                                            <div class="col-md-4">
                                                <div class="c-form-item">
                                                  	<label for="clients">&nbsp;</label>                                                   	
                                                   	<a href="javascript:void(0);" class="c-btn btn--emp js-add-jobtype"><i class="fa"></i>Add Job type</a>                                                    
                                                    <input type="hidden" name="siteBaseURL" id="siteBaseURL" value="<?php echo($siteBaseURL.'/addJobType.php'); ?>">													
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="content-header">
                                <h1 class="title" style="text-transform: capitalize;">ADD Project Type</h1>
                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="c-form-item">
                                                  	<label for="clients">&nbsp;</label>                                                   	
                                                   	<a href="javascript:void(0);" class="c-btn btn--emp js-add-projectType"><i class="fa"></i>Add Project Type</a>                                                    
                                                    <input type="hidden" name="siteBaseURL" id="siteBaseURL" value="<?php echo($siteBaseURL.'/addProjectType-new.php'); ?>">													
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        	<div class="col-md-12">
                                        		<div class="success">Project Type added</div>

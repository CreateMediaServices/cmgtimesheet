...
while ( $row = $result->fetch_assoc() ):
	$uProjectID[$counter] = $row[ "id" ];
	$uProjectType[$counter] = $row[ "projectType" ];
	$counter++;
endwhile;
                                        ...
                                        <div class="row">
                                        	<div class="col-md-3">
                                                <div class="c-form-item">
                                                    ...
                                                    <select style="width: 100%" name="projectType" id="projectType">
                                                    	<option value="0">Select Project Type</option>
<?php 
	$counter=0;
	while($counter < sizeof($uProjectType) ) :
?>
														<option value="<?php echo $uProjectID[$counter]; ?>"><?php echo $uProjectType[$counter]; ?></option>
<?php
		$counter++;
	endwhile;
?>
                                            ...
                                            <div class="col-md-3">
                                                <div class="c-form-item">
                                                    <label for="jobID">Need Job ID for this client</label>                                                    
                                            ...
                                            <div class="col-md-3">
                                                <div class="c-form-item">
                                                   	<label>&nbsp;</label>
                                                    <input type="button" class="c-btn js-add-client" value="Add Client">
                                                </div>
                                            </div>
                                        </div>
